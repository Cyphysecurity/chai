...
class CloudTrack:
    ...
    def forward(
        ...
        if not self.tracker_initialized:
            bbox, justification, justifications = self.add_keyframe(
        ...
        return bbox, self.current_justification, justifications
    ...
    def add_keyframe(self, frame: np.ndarray, category: str, description: str):
        ...
        return selected_box, justification, justifications
