...
if __name__ == "__main__":
    system_prompt = "You are an intelligent assistant searching for objects in images. " 
    llava = GwenWrapper(system_prompt=system_prompt)
